...
- The three key components of every plot: data, aesthetics and geoms, 小节 \@ref(basic-use)。

- How to add additional variables to a plot with aesthetics, 小节 \@ref(aesthetics)。

- How to display additional categorical variables in a plot using small multiples created by faceting, Section\@ref(qplot-faceting)。

- A variety of different geoms that you can use to create different types of
plots, 小节 \@ref(plot-geoms)。

- How to modify the axes, 小节 \@ref(axes)。

- Things you can do with a plot object other than display it, like save it to
disk, Section\@ref(output)。
